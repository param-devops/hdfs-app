...
# download hadoop
RUN wget -q -O - http://apache.mirrors.pair.com/hadoop/common/hadoop-2.7.3/hadoop-2.7.3/.tar.gz | tar -xzf - -C /usr/local \
...
RUN chown -R $HADOOP_USER:hadoop /usr/local/hadoop-2.7.3 && chmod -R 775 $HADOOP_CONF_DIR
